...
Engine::Engine():m_bRunning(false), m_gapCtr(0), m_gapMax(3)
{
...
void Engine::Update()
{
	...
	{
		//pop the first vec element off
		delete m_vec[0];
		m_vec[0] = nullptr;
		m_vec.erase(m_vec.begin()); //our 'pop_front'

	
		//add a new Box element to the end of the vec
		m_vec.push_back(new Box({ 1024,384 }, (m_gapCtr++ % m_gapMax == 0?true:false )));
